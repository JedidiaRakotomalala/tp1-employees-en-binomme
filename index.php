...
<body class="p-4 bg-light">
    ...
    <table class="table table-striped table-bordered table-hover bg-white" style="max-width: 800px;">
        ...
        ?>
                <tr>
                    <td><a class="fw-bold text-decoration-none" href="afficher_les_employees.php?id_dep=<?php echo $tout_les_departements_et_manager_avec_nombre[$i]["dept_no"] ; ?>"><?php echo $tout_les_departements_et_manager_avec_nombre[$i]["dept_no"] ; ?></a></td>
